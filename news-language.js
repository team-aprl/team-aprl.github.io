(() => {
  const translations = {
    "ugrp-2026-dori-excellence": `<span class="news-tag tag-award">수상</span>육성훈, 김지후, 김현동, 장재원 학생으로 구성된 UGRP 팀이 2026년 9월 11일 열린 <strong>2026 DGIST UGRP Conference</strong>에서 <a href="https://dgist-dori.github.io/" target="_blank" rel="noopener noreferrer"><em>DORI: DGIST O-shaped Robot with Interaction</em></a> 프로젝트로 <strong>우수상(Top 3)</strong>을 수상했습니다. 팀의 멋진 성과를 축하합니다!`,
