(() => {
  const translations = {
    "nrf-masters-fellowship-jiseon-kim": `<span class="news-tag tag-funding">연구비</span><a href="team.html#team-member-jiseon-kim">김지선</a> 님이 2026년도 한국연구재단 석사과정생연구장려금지원사업에 선정되었습니다. 축하합니다!`,
