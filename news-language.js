(() => {
  const translations = {
    "nrf-masters-fellowship-jiseon-kim": `<span class="news-tag tag-funding">연구비</span><a href="team.html#team-member-jiseon-kim">김지선</a> 님이 <a href="assets/news/nrf-2026-masters-student-research-fellowship-jiseon-kim.png">2026년도 한국연구재단 석사과정생연구장려금지원사업</a>에 선정되었습니다. 축하합니다!`,
    ...
    "nayak-joins": `<span class="news-tag tag-people">구성원</span>DGIST <a href="https://nbest.dgist.ac.kr/PROFESSOR.html">김철기 교수님 연구실</a>에서 근무한 <a href="team.html#team-member-bibhutibhusan-nayak">Nayak</a> 님이 <a href="https://www.hellodd.com/news/articleView.html?idxno=109383">InnoCORE 사업</a>을 통해 APRL에 합류했습니다. Magnetic SLAM 연구를 개척할 예정입니다.`,
