(() => {
  const translations = {
    "ugrp-2026-dori-excellence": `<span class="news-tag tag-award">수상</span><a href="team.html#ugrp-2026-dori">UGRP 팀(Prof. Joon-hyuk Park 공동지도)</a>이 <a href="assets/news/ugrp-2026-dori-excellence-preview.webp"><strong>2026 DGIST UGRP Conference</strong></a>에서 <a href="https://dgist-dori.github.io/" target="_blank" rel="noopener noreferrer">DORI: DGIST O-shaped Robot with Interaction</a> 프로젝트로 <a href="assets/news/ugrp-2026-dori-excellence-preview.webp"><strong>우수상(Top 2)</strong></a>을 수상했습니다. 팀의 멋진 성과를 축하합니다!`,
